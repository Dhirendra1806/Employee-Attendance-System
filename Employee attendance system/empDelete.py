...
def Empfour():
    ...
    bt4 = Button(c, text='DELETE', width=40, height=1, font=('Times new roman',15), command = empDelete)
    bt4.place(x=500, y=550)
    bt5 = Button(c, text='FIND', width=40, height=1, font=('Times new roman',15), command = finddata)
